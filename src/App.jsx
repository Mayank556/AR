  ...
  return (
    <>
      ...
      <div id="workspace" ref={workspaceRef} className={isFrontCam ? "mirrored" : ""}>
          ...
          <canvas ref={threeCanvasRef} id="three-canvas" style={{ display: is3DMode ? "block" : "none", position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 6, pointerEvents: 'none'}}></canvas>
      </div>
